    ...
    Console.WriteLine("Release version");
      ...
      Console.WriteLine("#define CG_Privado // código do professor.");
        ...
        protected override void OnLoad()
        {
            ...
            this.c = new Cubo(mundo, ref rotuloNovo);
        ...
        private void onLoadQ8()
        {
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, this.c._verticesQ4.Length * sizeof(float), this.c._verticesQ4, BufferUsageHint.StaticDraw);
            ...
            _diffuseMap = Texture.LoadFromFile("Resources/patrick.png");
        ...
        private void onLoadQ1()
        {
            ...
            _vertexBufferObject = GL.GenBuffer();
            GL.BindBuffer(BufferTarget.ArrayBuffer, _vertexBufferObject);
            GL.BufferData(BufferTarget.ArrayBuffer, this.c._verticesQ1.Length * sizeof(float), this.c._verticesQ1, BufferUsageHint.StaticDraw);
        ...
        private void onLoadQ2()//BASIC LIGHTING
        {
            ...
            _vertexBufferObject = GL.GenBuffer();
            GL.BindBuffer(BufferTarget.ArrayBuffer, _vertexBufferObject);
            GL.BufferData(BufferTarget.ArrayBuffer, this.c._verticesQ3.Length * sizeof(float), this.c._verticesQ3, BufferUsageHint.StaticDraw);
        ...
        private void onRenderFrameQ8()
        {
            ...
            */
            ...
            for (int i = 0; i < 1; i++)
            {
                Matrix4 model = Matrix4.CreateTranslation(this.c._cubePositions[i]);
                float angle = 20.0f * i;
