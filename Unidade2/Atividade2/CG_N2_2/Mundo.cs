    ...
    public class Mundo : GameWindow
    {
      ...
      -0.5f,  0.0f,  0.0f, /* X- */      0.5f,  0.0f,  0.0f, /* X+ */
       ...
       0.0f,  0.0f, -0.5f, /* Z- */      0.0f,  0.0f,  0.5f, /* Z+ */
        ...
        private int controladorTipoPrimitivo = 0;
        ...
        protected override void OnLoad()
        {
            ...
            obj_Retangulo = new Retangulo(null, new Ponto4D(-0.25, 0.25), new Ponto4D(-0.75, 0.75));
        ...
        protected override void OnUpdateFrame(FrameEventArgs e)
        {
            ...
            {
                obj_Retangulo.PrimitivaTipo = listaTipoPrimitivo[controladorTipoPrimitivo];
                controladorTipoPrimitivo++;
                if (controladorTipoPrimitivo == 6)
                {
                    controladorTipoPrimitivo = 0;
                }
            }
            #endregion
